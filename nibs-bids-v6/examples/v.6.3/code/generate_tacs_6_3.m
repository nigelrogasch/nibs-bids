...
% List of field
data.Name = 'Example dataset: tACS experiment';
...
md_content = {
    '# Example data set: transcranial alternating current stimulation'
    ''
    ['This data set provides an example of formatting using a proposed ' ...
    'nibs-bidsv6.3 standard.']
    ''
    '## Experiment details'
    'The experiment involves a single tACS.'
    ['tACS is given over left primary motor cortex.']
    ''
};
...
% List of files
fileNames = {'sub-001_task-rest_acq-tacs_nibs.tsv'};
...
data.event_id.Levels.tacs = 'Transcranial alternating current stimulation';
...
% fields
data.NIBSDescription = 'Transcranial Alternating Current Stimulation.';
